...
const resources = {
  "zh-CN": {
    translation: {
      ...
      community: {
        title: "交流与店铺",
        attribution: "本项目基于开源项目 grok2api 二次开发，在其账号池网关能力之上新增了 Grok 账号自动注册机等自定义功能。",
        attributionSource: "上游项目",
        attributionCustom: "自定义功能开发",
        groupHelp: "点击右侧按钮复制群号",
        storeTitle: "打开店铺",
        storeHelp: "查看服务与相关资源",
        noticeTitle: "本项目基于 grok2api 二次开发",
        noticeDescription: "感谢上游项目作者与开源社区。本项目保留 grok2api 的账号池网关能力，并在此基础上加入账号注册、邮箱池与凭证管理等功能。",
        noticeUpstream: "上游开源项目",
        noticeCustom: "本项目",
        ...
        storeLink: "店铺链接",
        donationAction: "赞赏码",
        donationTitle: "感谢你的赞赏",
        donationDescription: "如果这个项目对你有帮助，欢迎扫码支持一下。",
        donationImageAlt: "赞赏二维码：感谢你的赞赏",
        starTitle: "支持这个项目",
        starHelp: "如果这个项目对你有帮助，欢迎在 GitHub 点一个 Star。",
      ...
      registerTask: {
        title: "注册任务",
        description: "创建 Grok 账号注册任务，管理并发和邮箱来源，任务完成的账号会自动同步到账号池。",
        totalLabel: "本轮注册数量",
        concurrencyLabel: "并发窗口数",
        emailSourceLabel: "邮箱来源",
        emailSourceDuckmail: "DuckMail",
        emailSourceCloudMail: "Cloud Mail",
        emailSourceOutlook: "Outlook",
        emailSourceGoogle: "Google 账号",
        oauthExchangeLabel: "尝试换取 refresh_token",
        autoImportSub2ApiLabel: "注册成功后自动导入 Sub2API",
        sub2ApiProgress: "Sub2API 成功 {{succeeded}} · 失败 {{failed}}",
        minimizeBrowsersLabel: "最小化浏览器窗口",
        start: "开始注册",
        stop: "停止任务",
        retry: "重试上一轮",
        statusIdle: "空闲",
        ...
        startFailed: "启动失败",
        syncNow: "同步到账号池",
        syncCompleted: "已同步 {{count}} 个账号",
        syncFailed: "同步失败",
        outlookPoolLabel: "Outlook 账号池",
        outlookPoolPlaceholder: "email----password----clientId----refreshToken----auto/imap/graph 或 email|password|clientId|refreshToken|auto",
        loadOutlookPool: "加载本地账号池",
        saveOutlookPool: "保存账号池",
        outlookPoolLoaded: "已加载本地账号池（{{count}} 个账号）",
        outlookPoolLoadFailed: "加载 Outlook 账号池失败",
        outlookPoolSaved: "已保存 Outlook 账号池（{{count}} 个账号）",
        outlookPoolSaveFailed: "保存 Outlook 账号池失败",
        googlePoolLabel: "Google 账号池",
        googlePoolPlaceholder: "邮箱----Google 密码----辅助邮箱(可选) 或 邮箱|密码|辅助邮箱",
        cloudMailApiBaseLabel: "Cloud Mail 地址",
        cloudMailApiBasePlaceholder: "https://mail.example.com",
        cloudMailDomainsLabel: "邮箱域名",
        cloudMailDomainsPlaceholder: "example.com，多个域名用逗号分隔",
        cloudMailAuthModeLabel: "认证方式",
        cloudMailAuthPublic: "Public Token",
        cloudMailAuthLogin: "账号登录",
        cloudMailPublicTokenLabel: "Public Token",
        cloudMailLoginEmailLabel: "登录邮箱",
        cloudMailLoginPasswordLabel: "登录密码",
        cloudMailHelp: "API 地址末尾可包含 /api；每轮会创建一个随机邮箱并只读取该地址的新邮件。",
        poolRecognizedCount: "已识别 {{count}} 个账号",
        poolNoneRecognized: "未识别到有效账号",
        proxyPoolLabel: "注册代理池",
        proxyFilePlaceholder: "留空自动读取 ~/Downloads/xx.txt",
        proxyPoolHelp: "每个并发窗口随机领取一条未使用代理；同一任务内不复用。裸 HOST:PORT 按 HTTP 处理，仅支持无认证 HTTP/HTTPS 节点。",
        proxyPoolProgress: "代理已使用 {{used}}/{{total}}，剩余 {{remaining}}",
        proxyColumn: "代理",
        manageProxyPool: "管理已保存节点",
        proxySavedCount: "已保存 {{count}} 个节点。留空路径时会自动合并使用。",
        proxyDialogTitle: "导入注册节点",
        proxyDialogDescription: "粘贴每行一个 HOST:PORT 或无认证 HTTP/HTTPS 代理地址，保存后下次注册任务自动使用。",
        proxyDialogPlaceholder: "198.51.100.10:8080\nhttp://198.51.100.11:8080\nhttps://198.51.100.12:8443",
        proxySavedList: "当前已保存 {{count}} 个节点",
        proxySavedLoading: "正在读取已保存节点",
        proxyReplaceLabel: "替换现有节点",
        saveProxyPool: "保存节点",
        clearProxyPool: "清空已保存节点",
        proxyPoolSaved: "节点已保存，共 {{count}} 个，新增 {{added}} 个",
        proxyPoolSaveFailed: "保存节点失败",
        proxyPoolCleared: "已清空 {{count}} 个保存节点",
      },
      creativeConsole: {
        title: "创作控制台",
        description: "使用已创建的客户端密钥直接测试聊天、图片、视频和语音能力。",
        ...
        welcomeVoice: "输入文字合成语音，或上传音频进行识别",
        model: "模型",
        selectModel: "选择模型",
        noModels: "暂无可用模型",
        webSearch: "联网搜索",
        ...
        videoEditPlaceholder: "描述要对这段视频进行的修改。",
        videoExtendPlaceholder: "描述要延长这段视频的后续内容。",
        voicePlaceholder: "输入要合成语音的文字。",
        synthesize: "语音合成",
        transcribe: "语音识别",
        synthesizing: "正在合成语音...",
        transcribing: "正在识别语音...",
        ...
        firstFrameImageShort: "首帧",
        firstFrameImageAdded: "已添加首帧",
        clearFirstFrameImage: "移除首帧图片",
        referenceVoice: "参考音频",
        referenceVoiceShort: "参考音频",
        referenceVoiceNone: "不使用参考音频",
        sourceVideo: "源视频",
        sourceVideoShort: "源视频",
        sourceVideoAdded: "已添加视频",
        ...
        welcomeVideoEdit: "描述你想如何修改这段视频",
        welcomeVideoExtend: "描述你想如何延长这段视频",
        ...
        errors: {
          ...
          noSourceVideo: "请先提供要编辑或延长的源视频。",
          invalidImage: "请选择图片文件。",
          invalidVideo: "请选择视频文件。",
          noAudio: "请先选择音频文件。",
          videoFailed: "视频生成失败",
        },
      },
      ...
      audits: {
        ...
        operations: { responses: "Responses", compaction: "上下文压缩", chat: "Chat", messages: "Messages", image: "图像生成", image_edit: "图像编辑", video: "视频生成", stt: "语音识别", tts: "语音合成", realtime: "实时语音" },
  ...
  en: {
    translation: {
      ...
      community: { title: "Community & Store", attribution: "This project is built on top of the open-source grok2api project, adding a custom Grok account registration bot and other features on top of its account-pool gateway.", attributionSource: "Upstream project", attributionCustom: "Custom feature development", groupHelp: "Use the button to copy the group number", storeTitle: "Open the store", storeHelp: "Browse services and related resources", noticeTitle: "Built on top of grok2api", noticeDescription: "Thanks to the upstream authors and the open-source community. This project keeps grok2api's account-pool gateway and adds account registration, mailbox pools, and credential management.", noticeUpstream: "Upstream project", noticeCustom: "This project", noticeAcknowledge: "Got it", qqGroup: "QQ group", copyGroupNumber: "Copy group number", storeLink: "Store", donationAction: "Support", donationTitle: "Thank you for your support", donationDescription: "If this project has been useful, you can scan the code to support it.", donationImageAlt: "Support QR code: thank you for your support", starTitle: "Support this project", starHelp: "If this project helps you, a GitHub Star is appreciated.", starAction: "Star on GitHub" },
      ...
      registerTask: {
        title: "Registration",
        description: "Create Grok registration jobs, control concurrency and email source; completed accounts sync to the pool automatically.",
        totalLabel: "Accounts this round",
        concurrencyLabel: "Concurrent windows",
        emailSourceLabel: "Email source",
        emailSourceDuckmail: "DuckMail",
        emailSourceCloudMail: "Cloud Mail",
        emailSourceOutlook: "Outlook",
        emailSourceGoogle: "Google account",
        oauthExchangeLabel: "Attempt refresh_token exchange",
        autoImportSub2ApiLabel: "Import successful accounts to Sub2API",
        sub2ApiProgress: "Sub2API {{succeeded}} succeeded · {{failed}} failed",
        minimizeBrowsersLabel: "Minimize browser windows",
        start: "Start registration",
        stop: "Stop job",
        retry: "Retry last round",
        statusIdle: "Idle",
        ...
        started: "Registration job started",
        stopped: "Registration job stopped",
        startFailed: "Failed to start",
        syncNow: "Sync to account pool",
        syncCompleted: "Synced {{count}} accounts",
        syncFailed: "Sync failed",
        outlookPoolLabel: "Outlook account pool",
        outlookPoolPlaceholder: "email----password----clientId----refreshToken----auto/imap/graph or email|password|clientId|refreshToken|auto",
        loadOutlookPool: "Load local pool",
        saveOutlookPool: "Save account pool",
        outlookPoolLoaded: "Loaded local account pool ({{count}} accounts)",
        outlookPoolLoadFailed: "Failed to load Outlook account pool",
        outlookPoolSaved: "Saved Outlook account pool ({{count}} accounts)",
        outlookPoolSaveFailed: "Failed to save Outlook account pool",
        googlePoolLabel: "Google account pool",
        googlePoolPlaceholder: "email----Google password----recovery email (optional) or email|password|recovery email",
        cloudMailApiBaseLabel: "Cloud Mail URL",
        cloudMailApiBasePlaceholder: "https://mail.example.com",
        cloudMailDomainsLabel: "Mailbox domains",
        cloudMailDomainsPlaceholder: "example.com, comma-separated",
        cloudMailAuthModeLabel: "Authentication",
        cloudMailAuthPublic: "Public Token",
        cloudMailAuthLogin: "Account login",
        cloudMailPublicTokenLabel: "Public Token",
        cloudMailLoginEmailLabel: "Login email",
        cloudMailLoginPasswordLabel: "Login password",
        cloudMailHelp: "The URL may end in /api. Each round creates a random mailbox and reads only new messages for that address.",
        poolRecognizedCount: "{{count}} accounts recognized",
        poolNoneRecognized: "No valid accounts recognized",
        proxyPoolLabel: "Registration proxy pool",
        proxyFilePlaceholder: "Leave blank to use ~/Downloads/xx.txt",
        proxyPoolHelp: "Each concurrent window receives a random unused proxy; endpoints are not reused within a job. Bare HOST:PORT entries use HTTP. Only unauthenticated HTTP/HTTPS nodes are supported.",
        proxyPoolProgress: "Proxies used {{used}}/{{total}}, {{remaining}} remaining",
        proxyColumn: "Proxy",
        manageProxyPool: "Manage saved nodes",
        proxySavedCount: "{{count}} saved nodes. They are merged automatically when the path is blank.",
        proxyDialogTitle: "Import registration nodes",
        proxyDialogDescription: "Paste one HOST:PORT or unauthenticated HTTP/HTTPS proxy per line. Saved nodes are used by the next registration job.",
        proxyDialogPlaceholder: "198.51.100.10:8080\nhttp://198.51.100.11:8080\nhttps://198.51.100.12:8443",
        proxySavedList: "{{count}} nodes saved",
        proxySavedLoading: "Loading saved nodes",
        proxyReplaceLabel: "Replace existing nodes",
        saveProxyPool: "Save nodes",
        clearProxyPool: "Clear saved nodes",
        proxyPoolSaved: "Nodes saved: {{count}} total, {{added}} added",
        proxyPoolSaveFailed: "Failed to save nodes",
        proxyPoolCleared: "Cleared {{count}} saved nodes",
      },
      creativeConsole: {
        title: "Creative console",
        description: "Use an existing client key to test chat, image, video, and voice capabilities directly.",
        ...
        welcomeVoice: "Synthesize speech from text or transcribe an audio file",
        model: "Model",
        ...
        videoEditPlaceholder: "Describe the changes to make to this video.",
        videoExtendPlaceholder: "Describe what should happen after this video.",
        voicePlaceholder: "Enter the text to synthesize into speech.",
        ...
        clearFirstFrameImage: "Remove first-frame image",
        referenceVoice: "Reference audio",
        referenceVoiceShort: "Reference audio",
        referenceVoiceNone: "No reference audio",
        sourceVideo: "Source video",
        sourceVideoShort: "Source video",
        sourceVideoAdded: "Video added",
        ...
        extendDuration: "Extension duration (seconds)",
        videoActions: { generate: "Generate", edit: "Edit", extend: "Extend" },
        welcomeVideoEdit: "Describe how to edit this video",
        welcomeVideoExtend: "Describe how to extend this video",
        ...
        errors: {
          ...
          noSourceVideo: "Provide a source video to edit or extend first.",
          invalidImage: "Choose an image file.",
          invalidVideo: "Choose a video file.",
      ...
      audits: {
        ...
        operations: { responses: "Responses", compaction: "Context compaction", chat: "Chat", messages: "Messages", image: "Image generation", image_edit: "Image edit", video: "Video generation", stt: "Speech recognition", tts: "Text to speech", realtime: "Realtime voice" },
...
Object.assign(resources["zh-CN"].translation.accounts as unknown as Record<string, string>, {
  ...
  exportCpa: "CPA 导出", exportSub2api: "Sub2API 导出", cpaExported: "CPA 账号文件已导出", sub2apiExported: "Sub2API 账号文件已导出",
  importSub2api: "导入 Sub2API", importingSub2api: "正在导入", sub2apiImported: "已导入 Sub2API：成功 {{succeeded}} 个账号", sub2apiImportedPartial: "Sub2API 导入完成：成功 {{succeeded}}，失败 {{failed}}", sub2apiImportFailed: "Sub2API 导入失败：{{failed}} 个账号未导入",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, string>, {
  ...
  exportCpa: "Export CPA", exportSub2api: "Export Sub2API", cpaExported: "CPA account file exported", sub2apiExported: "Sub2API account file exported",
  importSub2api: "Import to Sub2API", importingSub2api: "Importing", sub2apiImported: "Imported {{succeeded}} account(s) to Sub2API", sub2apiImportedPartial: "Sub2API import completed: {{succeeded}} succeeded, {{failed}} failed", sub2apiImportFailed: "Sub2API import failed for {{failed}} account(s)",

...
const RegisterTaskPage = lazyNamed(() => import("@/features/register-task/register-task-page"), "RegisterTaskPage");
...
export function DeferredRegisterTaskPage() {
  return <DeferredPage page={RegisterTaskPage} />;
}

...
try:
    ...
    from ..grok_oauth_exchange import exchange_sso_for_oauth_tokens
...
class GrokProvider:
    ...
    def run_round(self, session: DrissionBrowserSession) -> RegistrationResult:
        ...
        _fill_code_and_submit(session, email, dev_token, self.stop_event)
...
def _fill_code_and_submit(session: DrissionBrowserSession, email: str, dev_token: str, stop_event=None, timeout: int = 180) -> str:

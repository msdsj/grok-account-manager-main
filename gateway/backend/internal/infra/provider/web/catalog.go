...
var catalog = []ModelSpec{
	...
	// The Web quota endpoint now exposes video720p for Basic accounts. Keep the
	// route available when that window is present; the upstream request remains
	// the final entitlement check for accounts whose product policy differs.
